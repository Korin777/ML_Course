class MLPlay:
    ...
    def update(self, scene_info):
        ...
        def check_grid():
            ...
            if self.car_pos[0] <= 35 and self.car_pos[0]!=0: # left bound
                grid.add(1)
                grid.add(4)
                grid.add(7)
        ...
        def move(grid, speed_ahead,speed_ahead1,speed_ahead2): 
            ...
            if len(grid) == 0:
                # if(self.car_pos[0]//70!=0 and self.lane_emp[self.car_pos[0]//70 - 1]):
                #     self.precom = ["SPEED","MOVE_LEFT"]
                #     return self.precom
                # elif(self.car_pos[0]//70!=8 and self.lane_emp[self.car_pos[0]//70+1]):
